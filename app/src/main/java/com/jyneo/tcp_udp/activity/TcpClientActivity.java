...
public class TcpClientActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.module_activity_tcp_client);
    ...
    private void initTitleBar() {
        ...
        myTitleBar.setOnClickListenerLeft(new MyTitleBar.OnClickListenerLeft() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TcpClientActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });

        // 设置中间的标题
        myTitleBar.setTitleText("TCP Client");
