...
public class UdpServerActivity extends BaseActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.module_activity_udp_server);
    ...
    private void initTitleBar() {
        ...
        myTitleBar.setOnClickListenerLeft(new MyTitleBar.OnClickListenerLeft() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UdpServerActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });

        // 设置中间的标题
        myTitleBar.setTitleText("UDP Server");
